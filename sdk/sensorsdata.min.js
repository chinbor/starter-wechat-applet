...
var sa = {},
  ...
  each = function (e, t, a) {
    ...
    if (nativeForEach && e.forEach === nativeForEach) e.forEach(t, a)
      ...
      for (var s = 0, i = e.length; s < i; s++) if (s in e && t.call(a, e[s], s, e) === r) return !1
    } else for (var n in e) if (hasOwnProperty.call(e, n) && t.call(a, e[n], n, e) === r) return !1
  }
function isObject(e) {
...
function setPublicPProperties(e) {
  if (e && e.properties) {
    var t = sa._.getRefPage(),
      ...
      r = { $referrer: t.route, $referrer_title: t.title, $title: a.title, $url: a.url }
...
;(kit.buildData = function (e, t) {
  var a = { distinct_id: sa.store.getDistinctId(), identities: sa.store._state.identities, lib: { $lib: sa.lib_name, $lib_method: 'code', $lib_version: sa.lib_version }, properties: {} }
  return (
    'track_id_unbind' === e.type && '$UnbindID' === e.event && ((a.identities = _.deepCopy(e.unbind_value)), delete e.unbind_value),
    _.isObject(t) || (t = {}),
    _.extend(a, sa.store.getUnionId(), e),
    _.isObject(e.properties) && !_.isEmptyObject(e.properties) && _.extend(a.properties, e.properties),
    (e.type && 'profile' === e.type.slice(0, 7)) ||
      ((a._track_id = Number(String(getRandom()).slice(2, 5) + String(getRandom()).slice(2, 4) + String(Date.now()).slice(-4))),
      (a.properties = _.extend({}, _.info.properties, sa.store.getProps(), _.info.currentProps, t, a.properties)),
      'track' === e.type && (a.properties.$is_first_day = _.getIsFirstDay()),
      setPublicPProperties(a)),
    a.properties.$time && _.isDate(a.properties.$time) ? ((a.time = 1 * a.properties.$time), delete a.properties.$time) : (a.time = 1 * new Date()),
  ...
  sendStrategy = {
    ...
    send: function (e) {
      ;(this.dataHasChange = !0),
        sa.store.mem.getLength() >= 500 && (sa._.logger.info('\u6570\u636e\u91cf\u5b58\u50a8\u8fc7\u5927\uff0c\u6709\u5f02\u5e38'), sa.store.mem.mdata.shift()),
        (e = kit.processData(e)) && sa.store.mem.add(e),
    ...
    batchSend: function () {
      if (this.dataHasSend) {
        ...
        ;(t = (e = a.length >= 100 ? a.slice(0, 100) : a).length) > 0 &&
          ((this.dataHasSend = !1), this.wxrequest({ data: e, len: t, success: this.batchRemove.bind(this), fail: this.sendFail.bind(this) }))
      }
    },
    sendFail: function () {
    ...
    batchWrite: function () {
      ...
      this.dataHasChange &&
        ...
        this.syncStorage && sa._.setStorageSync(sa.para.storage_prepare_data_key, sa.store.mem.mdata))
    },
...
function onceSend(e) {
  ...
  sa._.wxrequest({ url: t, method: 'GET' })
}
var saEvent = {
    send: function (e, t) {
  ...
  meta = {
    ...
    user: { LOGIN_ID_KEY: '$identity_login_id' },
  }
sa.popupEmitter = {
  attached: function () {
    return !1
...
function checkPrivacyStatus() {
  var e
  return (
    global && global.sensors_data_pre_config && (e = !!global.sensors_data_pre_config.is_compliance_enabled && global.sensors_data_pre_config.is_compliance_enabled),
...
function mpProxy(e, t, a) {
  ...
  if (e[t]) {
    var s = e[t]
    e[t] = function () {
      !sa.para.autoTrackIsFirst || (isObject(sa.para.autoTrackIsFirst) && !sa.para.autoTrackIsFirst[a])
        ? (s.apply(this, arguments), r.apply(this, arguments))
        : (!0 === sa.para.autoTrackIsFirst || (isObject(sa.para.autoTrackIsFirst) && sa.para.autoTrackIsFirst[a])) && (r.apply(this, arguments), s.apply(this, arguments))
    }
  } else
    e[t] = function () {
...
function monitorHooks(e) {
  sa.para.autoTrack && sa.para.autoTrack.pageLeave && pageLeaveProxy(e),
    ...
    'function' == typeof e.onShareTimeline && sa.autoTrackCustom.pageShareTimeline(e)
}
...
function isPresetIdKeys(e, t) {
  ...
  for (var r of (isArray(t) && (a = a.concat(t)), a)) if (r === e) return !0
  return !1
}
;(sa.kit = kit),
  ...
  (sa._ = _),
  (sa.IDENTITY_KEY = { EMAIL: '$identity_email', MOBILE: '$identity_mobile' }),
  ...
  (sa.para = {
    ...
    source_channel: [],
    autoTrack: { appLaunch: !0, appShow: !0, appHide: !0, pageShow: !0, pageShare: !0, mpClick: !1, mpFavorite: !0, pageLeave: !1 },
  ...
  (sa.setPara = function (e) {
    ...
    if (_.isArray(sa.para.source_channel))
      for (var a = sa.para.source_channel.length, r = 0; r < a; r++)
        -1 === ' utm_source utm_medium utm_campaign utm_content utm_term sa_utm '.indexOf(' ' + sa.para.source_channel[r] + ' ') && t.push(sa.para.source_channel[r])
    ...
    ;(e && e.datasend_timeout) || (sa.para.batch_send && (sa.para.datasend_timeout = 1e4)),
      !0 === sa.para.batch_send ? (sa.para.batch_send = _.extend({}, s)) : _.isObject(sa.para.batch_send) && (sa.para.batch_send = _.extend({}, s, sa.para.batch_send))
    var i = { share: !1, utm: !1 }
    !0 === sa.para.is_persistent_save
      ? ((sa.para.is_persistent_save = _.extend({}, i)), (sa.para.is_persistent_save.utm = !0))
      : _.isObject(sa.para.is_persistent_save) && (sa.para.is_persistent_save = _.extend({}, i, sa.para.is_persistent_save)),
      sa.para.server_url
        ? ((sa.para.preset_properties = _.isObject(sa.para.preset_properties) ? sa.para.preset_properties : {}),
          _.isObject(sa.para.autotrack_exclude_page) || (sa.para.autotrack_exclude_page = { pageShow: [], pageLeave: [] }),
          _.isArray(sa.para.autotrack_exclude_page.pageShow) || (sa.para.autotrack_exclude_page.pageShow = []),
          _.isArray(sa.para.autotrack_exclude_page.pageLeave) || (sa.para.autotrack_exclude_page.pageLeave = []))
        : logger.info(
...
;(_.decodeURIComponent = function (e) {
  ...
  (_.formatString = function (e) {
    return e.length > sa.para.max_string_length
      ? (logger.info('\u5b57\u7b26\u4e32\u957f\u5ea6\u8d85\u8fc7\u9650\u5236\uff0c\u5df2\u7ecf\u505a\u622a\u53d6--' + e), e.slice(0, sa.para.max_string_length))
      : e
  }),
    ...
    _.isObject(e) &&
      (_.each(e, function (t, a) {
        if (_.isFunction(t))
          try {
            ;(e[a] = t()),
              _.isFunction(e[a]) && (logger.info('\u60a8\u7684\u5c5e\u6027- ' + a + ' \u683c\u5f0f\u4e0d\u6ee1\u8db3\u8981\u6c42\uff0c\u6211\u4eec\u5df2\u7ecf\u5c06\u5176\u5220\u9664'), delete e[a])
          } catch (t) {
    ...
    return _.isObject(e)
      ? (_.each(e, function (t, a) {
          ...
          _.isString(t) ||
            ...
            _.isBoolean(t) ||
            _.isArray(t) ||
            (logger.info('\u60a8\u7684\u6570\u636e - ' + a + ':' + t + ' - \u683c\u5f0f\u4e0d\u6ee1\u8db3\u8981\u6c42\uff0c\u5df2\u7ecf\u5c06\u5176\u5220\u9664'), delete e[a])
        }),
        e)
      : e
  }),
  ...
  (_.utf8Encode = function (e) {
    ...
    for (t = a = 0, r = (e = (e + '').replace(/\r\n/g, '\n').replace(/\r/g, '\n')).length, s = 0; s < r; s++) {
      var n = e.charCodeAt(s),
        o = null
      n < 128 ? a++ : (o = n > 127 && n < 2048 ? String.fromCharCode((n >> 6) | 192, (63 & n) | 128) : String.fromCharCode((n >> 12) | 224, ((n >> 6) & 63) | 128, (63 & n) | 128)),
        null !== o && (a > t && (i += e.substring(t, a)), (i += o), (t = a = s + 1))
    }
  ...
  (_.base64Encode = function (e) {
    ...
    e = _.utf8Encode(e)
    do {
      ;(t = ((i = (e.charCodeAt(o++) << 16) | (e.charCodeAt(o++) << 8) | e.charCodeAt(o++)) >> 18) & 63),
        (a = (i >> 12) & 63),
        (r = (i >> 6) & 63),
        (s = 63 & i),
        (p[u++] = n.charAt(t) + n.charAt(a) + n.charAt(r) + n.charAt(s))
    } while (o < e.length)
  ...
  (_.btoa = function (e) {
    for (var t, a, r, s, i = 'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=', n = '', o = 0, _ = (e = String(e)).length % 3; o < e.length; )
      ((a = e.charCodeAt(o++)) > 255 || (r = e.charCodeAt(o++)) > 255 || (s = e.charCodeAt(o++)) > 255) &&
        logger.info("Failed to execute 'btoa' : The string to be encoded contains characters outside of the Latin1 range."),
        (n += i.charAt(((t = (a << 16) | (r << 8) | s) >> 18) & 63) + i.charAt((t >> 12) & 63) + i.charAt((t >> 6) & 63) + i.charAt(63 & t))
  ...
  (_.getCustomUtmFromQuery = function (e, t, a, r) {
    ...
    var s = {}
    if (e.sa_utm) for (var i in e) 'sa_utm' !== i ? _.include(sa.para.source_channel, i) && (s[a + i] = e[i]) : (s[r + i] = e[i])
    else for (var i in e) -1 === (' ' + source_channel_standard + ' ').indexOf(' ' + i + ' ') ? _.include(sa.para.source_channel, i) && (s[a + i] = e[i]) : (s[t + i] = e[i])
    return s
  }),
  ...
  (_.delObjectKey = function (e) {
    if ('[object Object]' === Object.prototype.toString.call(e)) for (var t = 0; t < share_info_key.length; t++) delete e[share_info_key[t]]
  ...
  (_.shareInfoData = function (e) {
    ...
    if (sa.para.preset_events.share_info_use_string) {
      ...
      t = { depth: Number(a.sensors_share_d), path: a.sensors_share_p || '', id: a.sensors_share_i || '', method: a.sensors_share_m || '' }
    } else {
  ...
  (_.setShareInfo = function (e, t) {
    ...
    'string' == typeof u ? ((t.$share_distinct_id = u), (share_distinct_id = u), (r.$latest_share_distinct_id = u)) : (t.$share_distinct_id = '\u53d6\u503c\u5f02\u5e38'),
      'number' == typeof n
        ? !share_distinct_id || (share_distinct_id !== s && share_distinct_id !== i)
          ? !share_distinct_id || (share_distinct_id === s && share_distinct_id === i)
            ? (t.$share_depth = '-1')
            : ((t.$share_depth = n + 1), (query_share_depth = n + 1), (r.$latest_share_depth = n + 1))
          : ((t.$share_depth = n), (query_share_depth = n), (r.$latest_share_depth = n))
        : (t.$share_depth = '-1'),
      'string' == typeof o ? ((t.$share_url_path = o), (r.$latest_share_url_path = o)) : (t.$share_url_path = '\u53d6\u503c\u5f02\u5e38'),
      'string' == typeof c ? ((t.$share_method = c), (r.$latest_share_method = c)) : (t.$share_method = '\u53d6\u503c\u5f02\u5e38'),
      _.setLatestShare(r)
  }),
  (_.getShareInfo = function () {
    if (sa.para.preset_events.share_info_use_string) {
      var e = { sensors_share_i: sa.store.getDistinctId() || '\u53d6\u503c\u5f02\u5e38', sensors_share_p: _.getCurrentPath(), sensors_share_d: query_share_depth, sensors_share_m: share_method }
      return _.objToParam(e, !0)
    }
    var t = JSON.stringify({ i: sa.store.getDistinctId() || '\u53d6\u503c\u5f02\u5e38', p: _.getCurrentPath(), d: query_share_depth, m: share_method })
  ...
  (_.detectOptionQuery = function (e) {
    ...
    var t,
      ...
      i = {}
    return (
      (i.query = _.extend({}, e.query)),
      'string' == typeof i.query.scene &&
        ((t = i.query),
        (a = ['utm_source', 'utm_content', 'utm_medium', 'utm_campaign', 'utm_term', 'sa_utm'].concat(sa.para.source_channel)),
        (r = new RegExp('(' + a.join('|') + ')%3D', 'i')),
        1 === (s = Object.keys(t)).length && 'scene' === s[0] && r.test(t.scene)) &&
        ((i.scene = i.query.scene), delete i.query.scene),
  ...
  (_.getMixedQuery = function (e) {
    ...
    return (
      a && ((a = -1 !== (a = _.decodeURIComponent(a)).indexOf('?') ? '?' + a.replace(/\?/g, '') : '?' + a), _.extend(s, _.getObjFromQuery(a))),
...
;(_.setRefPage = function () {
  ...
  (_.setPageRefData = function (e, t, a) {
    ...
    _.isObject(e) &&
      (t
        ? page_route_map.length > 0 && t
          ? ((a = a ? '?' + a : ''), (e.$referrer = _.getPath(t) + a), (e.$referrer_title = _.getPageTitle(t)))
          : ((e.$referrer = '\u76f4\u63a5\u6253\u5f00'), (e.$referrer_title = ''))
        : ((e.$referrer = r.route), (e.$referrer_title = r.title)))
  }),
    ...
    try {
      if (__wxConfig) {
        var a = __wxConfig,
          ...
          n = {}
        if (
          (a.global && a.global.window && a.global.window.navigationBarTitleText && (i.titleVal = a.global.window.navigationBarTitleText),
          s && s.window && s.window.navigationBarTitleText && (n.titleVal = s.window.navigationBarTitleText),
          !n.titleVal && __wxAppCode__)
        ) {
        ...
        wx.getSystemInfo({
          success: function (t) {
            ...
            ;(e.$brand = _.setUpperCase(t.brand)),
              ...
              (e.$os = ((a = t.platform), 'ios' === (r = a.toLowerCase()) ? 'iOS' : 'android' === r ? 'Android' : a)),
          ...
          complete: function () {
            ...
            _.isNumber(t) && (e.$timezone_offset = t),
              a.appId && (e.$app_id = a.appId),
              a.appVersion && (e.$app_version = a.appVersion),
  ...
  (sa.store = {
    ...
    toState: function (e) {
      ...
      if (this._state.identities && _.isObject(this._state.identities) && !_.isEmptyObject(this._state.identities)) {
        ...
        this._state.identities.hasOwnProperty('$mp_id') && ((this._state.identities.$identity_mp_id = this._state.identities.$mp_id), delete this._state.identities.$mp_id),
          this._state.identities.hasOwnProperty('$mp_unionid') && ((this._state.identities.$identity_mp_unionid = this._state.identities.$mp_unionid), delete this._state.identities.$mp_unionid),
          this._state.identities.hasOwnProperty(p) && ((this._state.identities[c] = this._state.identities[p]), delete this._state.identities[p]),
          this._state.identities.hasOwnProperty('$identity_anonymous_id') && (this._state.identities.$identity_anonymous_id = a || r)
      ...
      if ((s && (this._state.identities[c] = s), a))
        if (i && this._state.identities.hasOwnProperty(i)) {
          ...
          for (var d in ((this._state.identities[meta.user.LOGIN_ID_KEY] = r), this._state.identities))
            this._state.identities.hasOwnProperty(d) && '$identity_mp_id' !== d && d !== meta.user.LOGIN_ID_KEY && delete this._state.identities[d]
          this._state.history_login_id = { name: meta.user.LOGIN_ID_KEY, value: r }
        }
      else {
    ...
    set: function (e, t) {
      var a = {}
      for (var r in ('string' == typeof e ? (a[e] = t) : 'object' == typeof e && (a = e), (this._state = this._state || {}), a))
        (this._state[r] = a[r]), 'first_id' === r ? delete this._state._first_id : 'distinct_id' === r && (delete this._state._distinct_id, sa.events.emit('changeDistinctId'))
      this.save()
    },
    ...
    init: function () {
      ...
      if (e) _.isString(e) && -1 !== e.indexOf('data:enc;') && ((e = e.substring('data:enc;'.length)), (e = JSON.parse(_.rot13defs(e)))), this.toState(e)
        ...
        t.setHours(23),
          ...
          this.set({ distinct_id: this.getUUID(), first_visit_time: a, first_visit_day_time: t.getTime(), identities: { $identity_mp_id: this.getUUID() }, history_login_id: { name: '', value: '' } })
      }
    ...
    checkStoreInit: function () {
      meta.init_status &&
        (this.store_queue.length > 0 &&
          _.each(this.store_queue, function (e) {
  ...
  (sa.setProfile = function (e, t) {
    sa.saEvent.send({ type: 'profile_set', properties: e }, t)
  }),
  (sa.setOnceProfile = function (e, t) {
    sa.saEvent.send({ type: 'profile_set_once', properties: e }, t)
  }),
  (sa.appendProfile = function (e, t) {
    ...
    _.each(e, function (t, a) {
      ...
      sa.saEvent.send({ type: 'profile_append', properties: e }, t)
  }),
  (sa.incrementProfile = function (e, t) {
    if (!_.isObject(e)) return !1
    var a = e
    _.isString(e) && ((e = {})[a] = 1), sa.saEvent.send({ type: 'profile_increment', properties: e }, t)
  }),
  (sa.track = function (e, t, a) {
    this.saEvent.send({ type: 'track', event: e, properties: t }, a)
  }),
  (sa.identify = function (e, t) {
    if (!checkPrivacyStatus()) return !1
    if (!meta.init_status) return sa.store.store_queue.push({ method: 'identify', params: arguments }), !1
    if ((e = _.validId(e))) {
      ...
      !0 === t ? (a ? sa.store.set('first_id', e) : sa.store.set('distinct_id', e)) : a ? sa.store.change('first_id', e) : sa.store.change('distinct_id', e),
        sa.store.identitiesSet({ type: 'identify', id: e })
    }
  }),
  (sa.trackSignup = function (e, t, a, r) {
    ...
    sa.saEvent.send({ original_id: _, distinct_id: o, login_id: o, type: 'track_signup', event: i, properties: a }, r)
  }),
  ...
  (_.setLatestChannel = function (e) {
    _.isEmptyObject(e) ||
      ((function (e, t) {
        ...
        return a
      })(e, latest_source_channel) && (sa.clearAppRegister(latest_source_channel), sa.clearAllProps(latest_source_channel)),
      sa.para.is_persistent_save.utm ? sa.register(e) : sa.registerApp(e))
  }),
  (_.setLatestShare = function (e) {
    ;(e.$latest_share_depth || e.$latest_share_distinct_id || e.$latest_share_url_path || e.$latest_share_method) &&
      (sa.clearAppRegister(latest_share_info), sa.clearAllProps(latest_share_info), sa.para.is_persistent_save.share ? sa.register(e) : sa.registerApp(e))
  }),
  (sa.login = function (e) {
    ...
    isNewLoginId(r, e) &&
      ((sa.store._state.identities[r] = e),
      sa.store.set('history_login_id', { name: r, value: e }),
      t ? sa.trackSignup({ id: e, event_name: '$SignUp' }) : (sa.store.set('first_id', a), sa.trackSignup({ id: e, event_name: '$SignUp' })),
      sa.store.identitiesSet({ type: 'login', id: e, id_name: r }))
  }),
  (sa.loginWithKey = function (e, t) {
    ...
    var r = sa.store.getFirstId(),
      s = sa.store.getDistinctId()
    isNewLoginId(e, t) &&
      ((sa.store._state.identities[e] = t),
      sa.store.set('history_login_id', { name: e, value: t }),
      r ? sa.trackSignup({ id: t, event_name: '$SignUp', id_name: e }) : (sa.store.set('first_id', s), sa.trackSignup({ id: t, event_name: '$SignUp', id_name: e })),
      sa.store.identitiesSet({ type: 'login', id: t, id_name: e }))
  }),
  ...
  (sa.logout = function (e) {
    var t = sa.store.getFirstId()
    sa.store.identitiesSet({ type: 'logout' }),
      sa.store.set('history_login_id', { name: '', value: '' }),
  ...
  (sa.init = function (e) {
    ...
    ;(meta.init_status = !0),
      e && _.isObject(e) && sa.setPara(e),
      sa.store.init(),
      sa._.info.getSystem(),
      sa.checkPluginInitStatus(),
      sa.para.batch_send && sendStrategy.init(),
  ...
  (sa.getPresetProperties = function () {
    if (_.info && _.info.properties && _.info.properties.$lib) {
      ...
      var t = { $url_path: _.getCurrentPath(), $is_first_day: _.getIsFirstDay(), $is_first_time: is_first_launch },
  ...
  (sa.setOpenid = function (e, t) {
    if (!(e = _.validId(e))) return !1
    if (!checkPrivacyStatus()) return !1
    if (!meta.init_status) return sa.store.store_queue.push({ method: 'setOpenid', params: arguments }), !1
    t && console.log('%c \u5f53\u524d\u7248\u672c setOpenid \u63a5\u53e3 \u5df2\u4e0d\u652f\u6301\u4f20\u5165\u7b2c\u4e8c\u4e2a\u53c2\u6570', 'color:#F39C12;font-size: 14px;'),
  ...
  (sa.unsetUnionid = function (e) {
    ...
    if (t && sa.store._state.identities.hasOwnProperty('$identity_mp_unionid') && t === sa.store._state.identities.$identity_mp_unionid) {
      var a = _.getOpenidNameByAppid()
      sa.store._state.identities.hasOwnProperty(a) && (delete sa.store._state.identities[a], delete sa.store._state.openid, sa.store.save()),
  ...
  (sa.bind = function (e, t) {
    ...
    ;(sa.store._state.identities[e] = t), sa.store.save(), sa.saEvent.send({ type: 'track_id_bind', event: '$BindID' })
  }),
  (sa.unbind = function (e, t) {
    ...
    r === e + '+' + t && (sa.store.set('first_id', ''), sa.store.set('distinct_id', s), sa.store.set('history_login_id', { name: '', value: '' }))
    var i = {}
    ;(i[e] = t), sa.saEvent.send({ type: 'track_id_unbind', event: '$UnbindID', unbind_value: i })
  }),
  (sa.setWebViewUrl = function (e, t) {
    ...
    _.urlSafeBase64 && _.urlSafeBase64.encode ? (u = u ? _.urlSafeBase64.trim(_.urlSafeBase64.encode(_.urlBase64Encode(u))) : '') : this._.rot13obfs && (u = u ? _.rot13obfs(u) : ''),
      (u = encodeURIComponent(u))
    var p = c ? 'f' + u : 'd' + u
    t
      ? ((r = n.indexOf('_sasdk')),
        (o = n.indexOf('?') > -1 ? (r > -1 ? s + i + '#' + n.substring(1, r) + '_sasdk=' + p : s + i + '#' + n.substring(1) + '&_sasdk=' + p) : s + i + '#' + n.substring(1) + '?_sasdk=' + p))
      : ((r = i.indexOf('_sasdk')),
        (o = /^\?(\w)+/.test(i) ? (r > -1 ? s + i.replace(/(_sasdk=)([^&]*)/gi, '_sasdk=' + p) + n : s + '?' + i.substring(1) + '&_sasdk=' + p + n) : s + '?' + i.substring(1) + '_sasdk=' + p + n))
    return o
  }),
  _.each(
    [
  ...
  (_.sendPageLeave = function () {
    ...
    if (page_show_time >= 0 && '' !== t) {
      ...
      ;(isNaN(s) || s < 0) && (s = 0),
        ...
        (a.$title = r),
        (a.event_duration = s),
        -1 === sa.para.autotrack_exclude_page.pageLeave.indexOf(t) && sa.track('$MPPageLeave', a),
        (page_show_time = -1)
    }
  }),
  (sa.autoTrackCustom = {
    ...
    appLaunch: function (e, t) {
      ...
      var a = {}
      if (
        (e && e.scene ? ((current_scene = e.scene), (sa.current_scene = current_scene), (a.$scene = _.getMPScene(e.scene))) : (a.$scene = '\u672a\u53d6\u5230\u503c'),
        e && e.scene && 1010 === e.scene && e.query && (e.query.sampshare && delete e.query.sampshare, _.delObjectKey(e.query)),
        e && e.path && ((a.$url_path = _.getPath(e.path)), (a.$title = _.getPageTitle(e.path)), e.query && _.isObject(e.query)))
      ) {
      ...
      _.setShareInfo(e, a)
      var s = _.setUtm(e, a)
      is_first_launch ? ((a.$is_first_time = !0), _.isEmptyObject(s.pre1) || sa.setOnceProfile(s.pre1)) : (a.$is_first_time = !1),
        _.setLatestChannel(s.pre2),
        _.setSfSource(e, a),
        sa.registerApp({ $latest_scene: a.$scene }),
        (a.$url_query = _.setQuery(e.query)),
        _.setPageRefData(a),
        t ? ((a = _.extend(a, t)), sa.track('$MPLaunch', a)) : sa.para.autoTrack && sa.para.autoTrack.appLaunch && sa.autoTrackCustom.trackCustom('appLaunch', a, '$MPLaunch')
    },
    appShow: function (e, t) {
      ...
      ;(mpshow_time = new Date().getTime()),
        e && e.scene ? ((current_scene = e.scene), (sa.current_scene = current_scene), (a.$scene = _.getMPScene(e.scene))) : (a.$scene = '\u672a\u53d6\u5230\u503c'),
        e && e.scene && 1010 === e.scene && e.query && (e.query.sampshare && delete e.query.sampshare, _.delObjectKey(e.query)),
        e && e.path && ((a.$url_path = _.getPath(e.path)), (a.$title = _.getPageTitle(e.path))),
        _.setShareInfo(e, a)
      var r = _.setUtm(e, a)
      _.setLatestChannel(r.pre2),
        ...
        sa.registerApp({ $latest_scene: a.$scene }),
        (a.$url_query = _.setQuery(e.query)),
        _.setPageRefData(a, e.path, a.$url_query),
        e && e.path && (a.$url = e.path + (a.$url_query ? '?' + a.$url_query : '')),
        t ? ((a = _.extend(a, t)), sa.track('$MPShow', a)) : sa.para.autoTrack && sa.para.autoTrack.appShow && sa.autoTrackCustom.trackCustom('appShow', a, '$MPShow')
    },
    appHide: function (e) {
      var t = new Date().getTime(),
        a = {}
      ;(a.$url_path = _.getCurrentPath()),
        mpshow_time && t - mpshow_time > 0 && (t - mpshow_time) / 36e5 < 24 && (a.event_duration = (t - mpshow_time) / 1e3),
        _.setPageRefData(a),
        e ? ((a = _.extend(a, e)), sa.track('$MPHide', a)) : sa.para.autoTrack && sa.para.autoTrack.appHide && sa.autoTrackCustom.trackCustom('appHide', a, '$MPHide'),
        sendStrategy.onAppHide()
    },
    pageLoad: function (e) {
      current_scene && 1010 === current_scene && e && (e.sampshare && delete e.sampshare, _.delObjectKey(e)),
    ...
    pageShow: function () {
      ...
      _.setRefPage(),
        ...
        _.setPageSfSource(e),
        a && (e.$title = a),
        sa.para.onshow ? sa.para.onshow(sa, t, this) : -1 === sa.para.autotrack_exclude_page.pageShow.indexOf(t) && sa.autoTrackCustom.trackCustom('pageShow', e, '$MPViewScreen')
    },
      ...
      e.onShareAppMessage = function () {
        ...
        return (
          sa.para.allow_amend_share_path &&
            ...
            'object' != typeof e || (void 0 !== e.path && '' !== e.path) || (e.path = _.getCurrentUrl(this)),
      ...
      e.onShareTimeline = function () {
        ...
        return (
          sa.para.allow_amend_share_path &&
            ...
            'object' == typeof e && 'string' == typeof e.query && '' !== e.query && '&' !== e.query.slice(-1) && (e.query = e.query + '&'),
  ...
  (sa.quick = function () {
    ...
    if ('getAnonymousID' === e) {
      ...
      'appLaunch' === e || 'appShow' === e
        ...
        : 'appHide' === e && ((r = _.isObject(t) ? t : {}), sa.autoTrackCustom[e](r))
  }),
  (sa.appLaunch = function (e, t) {
    ...
    e && e.scene ? ((current_scene = e.scene), (sa.current_scene = current_scene), (a.$scene = _.getMPScene(e.scene))) : (a.$scene = '\u672a\u53d6\u5230\u503c'),
      ...
      _.setShareInfo(e, a)
    var r = _.setUtm(e, a)
    is_first_launch ? ((a.$is_first_time = !0), _.isEmptyObject(r.pre1) || sa.setOnceProfile(r.pre1)) : (a.$is_first_time = !1),
      _.setLatestChannel(r.pre2),
      _.setSfSource(e, a),
      sa.registerApp({ $latest_scene: a.$scene }),
      (a.$url_query = _.setQuery(e.query)),
